...
export default function LearningPage() {
  return (
    <div className="flex flex-col gap-8 pb-16">
      ...
      {/* Grid Layout: Roadmap & Glossary (Left) + Quiz (Right) - Set to items-start to prevent quiz card stretching */}
      <SectionWrapper className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        {/* Interactive Quiz - Removed h-full to let height adjust to screen states */}
