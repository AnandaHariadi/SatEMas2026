    ...
    <div className="flex flex-col gap-8 pb-16">
      ...
      <SectionWrapper className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-slate-200 p-5 rounded-2xl shadow-sm">
          ...
          <div className="bg-slate-50 p-3 rounded-lg border border-slate-200 font-mono text-[10px] text-[#064e3b] leading-normal font-bold">
        ...
        <div className="bg-white border border-slate-200 p-5 rounded-2xl shadow-sm">
          ...
          <div className="bg-slate-50 p-3 rounded-lg border border-slate-200 font-mono text-[10px] text-emerald-700 leading-normal font-bold">
